 ...
 * </p>
 * <ul>
 *   <li>{@link idm.uikit.mm.uikit.impl.PageImpl#getName <em>Name</em>}</li>
 *   <li>{@link idm.uikit.mm.uikit.impl.PageImpl#getPagecontents <em>Pagecontents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PageImpl extends MinimalEObjectImpl.Container implements Page {
	...
	protected EClass eStaticClass() {
		return UikitPackage.Literals.PAGE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UikitPackage.PAGE__NAME, oldName, name));
	}
	...
	public EList<PageContent> getPagecontents() {
		if (pagecontents == null) {
			pagecontents = new EObjectContainmentEList<PageContent>(PageContent.class, this,
					UikitPackage.PAGE__PAGECONTENTS);
		}
		return pagecontents;
	}
