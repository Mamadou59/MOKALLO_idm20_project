...
/**
 * This is the item provider adapter for a {@link idm.uikit.mm.uikit.TextContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextContainerItemProvider extends TextPageContentItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UikitPackage.Literals.TEXT_CONTAINER__TEXTELEMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(UikitPackage.Literals.TEXT_CONTAINER__TEXTELEMENTS,
				UikitFactory.eINSTANCE.createButton()));

		newChildDescriptors.add(createChildParameter(UikitPackage.Literals.TEXT_CONTAINER__TEXTELEMENTS,
				UikitFactory.eINSTANCE.createLink()));

		newChildDescriptors.add(createChildParameter(UikitPackage.Literals.TEXT_CONTAINER__TEXTELEMENTS,
				UikitFactory.eINSTANCE.createImage()));
