 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.sample.basicwebsite.impl.TextContainerImpl#getTextelement <em>Textelement</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TextContainerImpl extends PageContentImpl implements TextContainer {
	...
	protected EClass eStaticClass() {
		return BasicwebsitePackage.Literals.TEXT_CONTAINER;
	}
	...
	public EList<TextElement> getTextelement() {
		if (textelement == null) {
			textelement = new EObjectContainmentEList<TextElement>(TextElement.class, this,
					BasicwebsitePackage.TEXT_CONTAINER__TEXTELEMENT);
		}
		return textelement;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case BasicwebsitePackage.TEXT_CONTAINER__TEXTELEMENT:
