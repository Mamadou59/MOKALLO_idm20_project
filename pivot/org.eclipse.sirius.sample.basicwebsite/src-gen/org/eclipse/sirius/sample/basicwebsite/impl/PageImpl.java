 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.sample.basicwebsite.impl.PageImpl#getContents <em>Contents</em>}</li>
...
public class PageImpl extends MinimalEObjectImpl.Container implements Page {
	...
	public EList<PageContent> getContents() {
		if (contents == null) {
			contents = new EObjectContainmentEList<PageContent>(PageContent.class, this,
					BasicwebsitePackage.PAGE__CONTENTS);
		}
		return contents;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case BasicwebsitePackage.PAGE__CONTENTS:
