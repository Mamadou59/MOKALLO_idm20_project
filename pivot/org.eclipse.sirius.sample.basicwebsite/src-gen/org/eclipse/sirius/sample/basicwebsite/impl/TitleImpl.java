 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.sample.basicwebsite.impl.TitleImpl#getLevel <em>Level</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TitleImpl extends TextContainerImpl implements Title {
	...
	protected EClass eStaticClass() {
		return BasicwebsitePackage.Literals.TITLE;
	}
	...
	public void setLevel(int newLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicwebsitePackage.TITLE__LEVEL, oldLevel, level));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case BasicwebsitePackage.TITLE__LEVEL:
			return getLevel();
		}
