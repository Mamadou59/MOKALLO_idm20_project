 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.sample.basicwebsite.impl.TextElementImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TextElementImpl extends MinimalEObjectImpl.Container implements TextElement {
	...
	protected EClass eStaticClass() {
		return BasicwebsitePackage.Literals.TEXT_ELEMENT;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicwebsitePackage.TEXT_ELEMENT__TEXT, oldText,
					text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case BasicwebsitePackage.TEXT_ELEMENT__TEXT:
			return getText();
		}
