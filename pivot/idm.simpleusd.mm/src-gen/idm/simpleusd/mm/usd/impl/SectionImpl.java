 ...
 * </p>
 * <ul>
 *   <li>{@link idm.simpleusd.mm.usd.impl.SectionImpl#getContents <em>Contents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SectionImpl extends PageContentImpl implements Section {
	...
	public EList<PageContent> getContents() {
		if (contents == null) {
			contents = new EObjectContainmentEList<PageContent>(PageContent.class, this, UsdPackage.SECTION__CONTENTS);
		}
		return contents;
	}
