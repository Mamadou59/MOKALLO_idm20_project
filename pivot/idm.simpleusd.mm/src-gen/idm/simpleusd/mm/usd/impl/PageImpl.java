 ...
 * </p>
 * <ul>
 *   <li>{@link idm.simpleusd.mm.usd.impl.PageImpl#getName <em>Name</em>}</li>
 *   <li>{@link idm.simpleusd.mm.usd.impl.PageImpl#getContents <em>Contents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PageImpl extends MinimalEObjectImpl.Container implements Page {
	...
	protected EClass eStaticClass() {
		return UsdPackage.Literals.PAGE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UsdPackage.PAGE__NAME, oldName, name));
	}
	...
	public EList<PageContent> getContents() {
		if (contents == null) {
			contents = new EObjectContainmentEList<PageContent>(PageContent.class, this, UsdPackage.PAGE__CONTENTS);
		}
		return contents;
	}
