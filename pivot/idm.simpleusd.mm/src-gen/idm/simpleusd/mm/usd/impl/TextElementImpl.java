 ...
 * </p>
 * <ul>
 *   <li>{@link idm.simpleusd.mm.usd.impl.TextElementImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TextElementImpl extends MinimalEObjectImpl.Container implements TextElement {
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UsdPackage.TEXT_ELEMENT__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case UsdPackage.TEXT_ELEMENT__TEXT:
			return getText();
		}
