 ...
 * @generated
 */
public class LinkPropertyItemProvider extends ButtonStyleItemProvider {
	/**
	...
	public String getText(Object object) {
		Color labelValue = ((LinkProperty) object).getColor();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_LinkProperty_type")
