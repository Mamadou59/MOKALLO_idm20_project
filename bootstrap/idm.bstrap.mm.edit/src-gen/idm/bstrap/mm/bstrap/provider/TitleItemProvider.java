...
/**
 * This is the item provider adapter for a {@link idm.bstrap.mm.bstrap.Title} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TitleItemProvider extends TextContainerItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BstrapPackage.Literals.TITLE__DISPLAYPROPERTIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(BstrapPackage.Literals.TITLE__DISPLAYPROPERTIES,
				BstrapFactory.eINSTANCE.createDisplay1()));

		newChildDescriptors.add(createChildParameter(BstrapPackage.Literals.TITLE__DISPLAYPROPERTIES,
				BstrapFactory.eINSTANCE.createDisplay2()));

		newChildDescriptors.add(createChildParameter(BstrapPackage.Literals.TITLE__DISPLAYPROPERTIES,
				BstrapFactory.eINSTANCE.createDisplay3()));

		newChildDescriptors.add(createChildParameter(BstrapPackage.Literals.TITLE__DISPLAYPROPERTIES,
				BstrapFactory.eINSTANCE.createDisplay4()));
	}
