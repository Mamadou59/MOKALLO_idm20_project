 ...
 *   <li>{@link idm.bstrap.mm.bstrap.impl.NavigationImpl#getLinks <em>Links</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NavigationImpl extends TextPageContentImpl implements Navigation {
	...
	public EList<Link> getLinks() {
		if (links == null) {
			links = new EObjectContainmentEList<Link>(Link.class, this, BstrapPackage.NAVIGATION__LINKS);
		}
		return links;
	}
