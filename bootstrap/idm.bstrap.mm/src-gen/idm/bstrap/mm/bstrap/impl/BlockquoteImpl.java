 ...
 * @generated
 */
public class BlockquoteImpl extends PageContentImpl implements Blockquote {
	/**
	...
	protected EClass eStaticClass() {
		return BstrapPackage.Literals.BLOCKQUOTE;
	}
	...
	public EList<PageContent> getPagecontents() {
		if (pagecontents == null) {
			pagecontents = new EObjectContainmentEList<PageContent>(PageContent.class, this,
					BstrapPackage.BLOCKQUOTE__PAGECONTENTS);
		}
		return pagecontents;
	}
