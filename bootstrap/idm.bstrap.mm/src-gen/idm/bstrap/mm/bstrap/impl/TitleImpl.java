 ...
 * </p>
 * <ul>
 *   <li>{@link idm.bstrap.mm.bstrap.impl.TitleImpl#getLevel <em>Level</em>}</li>
 *   <li>{@link idm.bstrap.mm.bstrap.impl.TitleImpl#getDisplayproperties <em>Displayproperties</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TitleImpl extends TextContainerImpl implements Title {
	...
	protected EClass eStaticClass() {
		return BstrapPackage.Literals.TITLE;
	}
	...
	public void setLevel(int newLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BstrapPackage.TITLE__LEVEL, oldLevel, level));
	}
	...
	public EList<DisplayProperty> getDisplayproperties() {
		if (displayproperties == null) {
			displayproperties = new EObjectContainmentEList<DisplayProperty>(DisplayProperty.class, this,
					BstrapPackage.TITLE__DISPLAYPROPERTIES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case BstrapPackage.TITLE__DISPLAYPROPERTIES:
